<div class="ordersPackages index">
	<h2><?php echo __('Orders Packages'); ?></h2>
	...
	<tbody>
	<?php foreach ($ordersPackages as $ordersPackage): ?>
	<tr>
		<td><?php echo h($ordersPackage['OrdersPackage']['id']); ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $ordersPackage['OrdersPackage']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $ordersPackage['OrdersPackage']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $ordersPackage['OrdersPackage']['id']), array(), __('Are you sure you want to delete # %s?', $ordersPackage['OrdersPackage']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
