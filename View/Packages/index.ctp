<div class="packages index">
	...
	<tr>
		...
		<td><?php echo h($package['Package']['slug']); ?>&nbsp;</td>
		<td><?php echo h($package['Package']['visible']); ?>&nbsp;</td>
		<td><?php echo h($package['Package']['img']); ?>&nbsp;</td>
		<td><?php echo h($package['Package']['metatitle']); ?>&nbsp;</td>
		<td><?php echo h($package['Package']['metadescription']); ?>&nbsp;</td>
		<td><?php echo h($package['Package']['content']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $package['Package']['id']), array(), __('Are you sure you want to delete # %s?', $package['Package']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
