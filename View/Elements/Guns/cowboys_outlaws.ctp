...
<h3>Cowboys & Outlaws</h3>
<h4>1867 - 1890</h4>
</div>
</div>
<div class="row history-body">
<div class="col-xs-12 ">
    <h3>BLAZING A CATTLE TRAIL</h3>
	<h4>
...
Nelson Story for his epic Western story, <em>Lonesome Dove</em>.
...
<?=$this->Html->link('Book Now',array('action'=>'packages','#'=>'gunfighter_and_outlaw'),array('class'=>'btn btn-lg btn-danger date-btns','style'=>''))?>
</div>
<div class="col-xs-12 col-md-6" style="padding-top:10px">
