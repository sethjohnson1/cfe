...
<tbody>
 ...
 <td>
 <? 
 if ($pkg['Product']['Price']>$pkg['Product']['OnlinePrice'])
 echo '<strike>'.money_format('$%i',$pkg['Product']['Price']).'</strike>'. '&nbsp;&nbsp;<span style="color:red">'.money_format('$%i',$pkg['Product']['OnlinePrice']).' Online special!</span>';
else echo money_format('$%i',$pkg['Product']['OnlinePrice']);
